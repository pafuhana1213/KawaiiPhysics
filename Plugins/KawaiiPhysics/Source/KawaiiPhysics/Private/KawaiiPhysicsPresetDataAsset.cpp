...
namespace
{
	...
	const TSet<FName>& GetCopyTargetPropertyNames()
	{
		static const TSet<FName> Names = {
			...
			GET_MEMBER_NAME_CHECKED(FAnimNode_KawaiiPhysics, SimpleWorldCollisionComplexShapeApproximation),
			...
			GET_MEMBER_NAME_CHECKED(FAnimNode_KawaiiPhysics, bSimpleWorldCollisionApproximateGround),
			GET_MEMBER_NAME_CHECKED(FAnimNode_KawaiiPhysics, SimpleWorldCollisionSkeletalMeshMode),
