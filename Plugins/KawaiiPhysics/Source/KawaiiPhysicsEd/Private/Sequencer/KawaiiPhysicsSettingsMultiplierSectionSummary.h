 ...
 */
KAWAIIPHYSICSED_API FText MakeKawaiiPhysicsScaleSummaryText(const FKawaiiPhysicsSettingsMultiplier& Scale);
 ...
 */
KAWAIIPHYSICSED_API FString MakeKawaiiPhysicsScaleSummaryString(const FKawaiiPhysicsSettingsMultiplier& Scale);
